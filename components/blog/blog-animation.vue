     ...
     <section class="relative md:py-24 py-16" id="blog">
            <div class="container">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px] mt-8">
                    <div v-for="item in blogs" :key="item" class="blog relative rounded-lg shadow shadow-slate-200 dark:shadow-gray-800 overflow-hidden wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <img :src="item.image" alt="">

                        <div class="content p-6">
                            <a href="" class="text-[17px] hover:text-amber-500 dark:text-white dark:hover:text-amber-500 transition duration-500 ease-in-out font-medium h5">{{item.title}}</a>
...
<script>
   import blog from '../../assets/images/blog/01_giglink.jpg'
import blog2 from '../../assets/images/blog/01_techwind.jpg'
import blog3 from '../../assets/images/blog/01_upwind.jpg'
